...
def test_accuracy():
    ...
    # Test Case 2: Five houses
    nums2 = [2, 7, 9, 3, 1]
    result2 = solution.rob(nums2)
    assert result2 == 12, f"Failed for {nums2}, expected 12, got {result2}"

    # Test Case 3: Two houses
    nums3 = [2, 1]
    result3 = solution.rob(nums3)
    assert result3 == 2, f"Failed for {nums3}, expected 2, got {result3}"

    # Test Case 4: Single house
    nums4 = [5]
    result4 = solution.rob(nums4)
    assert result4 == 5, f"Failed for {nums4}, expected 5, got {result4}"

    # Test Case 5: Three houses
    nums5 = [1, 2, 3]
    result5 = solution.rob(nums5)
    assert result5 == 4, f"Failed for {nums5}, expected 4, got {result5}"
    ...
    assert result7 == 9, f"Failed for {nums7}, expected 9, got {result7}"
...
def test_edge_cases():
    ...
    nums2 = [i % 400 + 1 for i in range(100)]
    result2 = solution.rob(nums2)
    assert isinstance(result2, int), f"Max constraint failed: {result2}"
    print(f"Maximum constraint: ✅")

    # Edge Case 3: Maximum money (400)
    nums3 = [400, 1, 400]
    result3 = solution.rob(nums3)
    assert result3 == 800, f"Max money failed: {result3}"
    ...
    nums5 = [1, 0, 1, 0, 1]
    result5 = solution.rob(nums5)
    assert result5 == 3, f"Alternating pattern failed: {result5}"
...
if __name__ == "__main__":
    print("🧪 Testing House Robber Problem")
    print("=" * 50)
