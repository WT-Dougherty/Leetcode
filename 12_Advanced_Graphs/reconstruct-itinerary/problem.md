...
For example, the itinerary ["JFK", "LGA"] has a smaller lexicographical order than ["JFK", "LGB"].
...
Explanation: Another possible reconstruction is ["JFK","SFO","ATL","JFK","ATL","SFO"] but it is larger in lexicographical order.
```
